...
$sql = "SELECT Booking.Booking_ID, 
               ...
               Photo_Studio.Name AS Studio_Name, 
               Photo_Session.Name AS Session_Name, 
               Booking.Print_Requested, 
               COALESCE(Photo_Printing.Print_Type, 'N/A') AS Printing_Type,
               Booking.Booking_DateTime
        FROM Booking
        INNER JOIN Client ON Booking.Client_ID = Client.Client_ID
        INNER JOIN Photographer ON Booking.Photographer_ID = Photographer.Photographer_ID
        INNER JOIN Photo_Studio ON Booking.Photo_Studio_ID = Photo_Studio.Photo_Studio_ID
        INNER JOIN Photo_Session ON Booking.Session_ID = Photo_Session.Session_ID
        LEFT JOIN Photo_Printing ON Booking.Printing_ID = Photo_Printing.Printing_ID";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td>" . $row["Photographer_First_Name"] . " " . $row["Photographer_Last_Name"] . "</td>
                <td>" . $row["Studio_Name"] . "</td>
                <td>" . $row["Session_Name"] . "</td>
                <td>" . ($row["Print_Requested"] ? "Yes" : "No") . "</td>
