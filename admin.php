...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'administrator') {
    // Если не авторизован или не является администратором, перенаправляем на страницу авторизации
...
<head>
  ...
  .admin-button {
    width: 100%; /* Make the buttons fill the available width */
  }
    </style>
</head>
<body>
...
<div class="admin-panel">
    <p class="welcome-message">Добро пожаловать на панель администратора, <?php echo $_SESSION['login']; ?></p>
  
    <div class="admin-buttons">
      <button class="admin-button" onclick="editPhotographerPage()">Редактировать фотографов</button>
      <!-- <button class="admin-button" onclick="editPhotostudioPage()">Редактировать фотозалы</button> -->
      <button class="admin-button" onclick="editPhotosessionPage()">Редактировать фотосессии</button>
      <button class="admin-button " onclick="editAccPage()">Редактировать аккаунты</button>
    
      <button class="admin-button" onclick="bookingViewPage()">Просмотреть записи</button>
      <button class="admin-button " onclick="clientPage()">Просмотреть клиентов</button>
    </div>
  </div>
  ...
  function bookingViewPage() {
    // Перенаправляем на файл booking-info.php
    window.location.href = 'booking-info.php';
  }
  function clientPage() {
  ...
  function editPhotographerPage() {
   window.location.href = "edit-photographer.php";
}
function editPhotosessionPage() {
   window.location.href = "edit-photosession.php";
}

function editPhotostudioPage() {
   window.location.href = "edit-photostudio.php";
}

function editAccPage() {
   window.location.href = "edit-acc.php";
}
