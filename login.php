...
<header class="header">
    ...
    <div class="auth-container container">
        ...
        <form method="post" action="login.php">
            ...
            <input type="text" name="login" class="auth-input" required><br>

            <label for="password" class="auth-label">Пароль:</label>
            <input type="password" name="password" class="auth-input" required><br>

            <button type="submit" class="auth-button">Войти</button>
        </form>

        <p class="auth-register-link">Нет аккаунта? <a href="register.php">Зарегистрируйтесь</a></p>
    </div>
